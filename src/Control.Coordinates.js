...
L.Control.Coordinates = L.Control.extend({
	...
	*/
	...
	_handleSubmit: function() {
        console.log(this._inputX.value);
	...
	_update: function(evt) {
		...
		if (pos) {
			...
			this._inputY.value = opts.coordinateConverter ? opts.coordinateConverter(pos.lng, pos.lat).y : L.NumberFormatter.round(pos.lat, opts.decimals, opts.decimalSeperator);
			this._inputX.value = opts.coordinateConverter ? opts.coordinateConverter(pos.lng, pos.lat).x : L.NumberFormatter.round(pos.lng, opts.decimals, opts.decimalSeperator);
